    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        items: [
          ...
          const BottomNavigationBarItem(icon: Icon(Icons.search_outlined), label: "Home",),
          const BottomNavigationBarItem(icon: Icon(Icons.shopping_cart_outlined), label: "Home",),
